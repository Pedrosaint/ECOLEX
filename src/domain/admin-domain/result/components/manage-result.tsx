...
// const renderTabContent = () => {
//   const fontClass = "text-2xl font-bold font-sans mb-4";

//   switch (activeTab) {
//     case "Setup Grades":
//       return (
//         <div>
//           <h2 className={fontClass}>Setup Grades</h2>
//           <SetupGradesTab />
//         </div>
//       );
//     case "View Class Result":
//       return (
//         <div>
//           <h2 className={fontClass}>View Class Result</h2>
//           <ViewClassResultTab />
//         </div>
//       );
//     case "View students Result":
//       return (
//         <div>
//           <h2 className={fontClass}>View Students Result</h2>
//           <ViewStudentsResultTab />
//         </div>
//       );
//     case "View Teacher Result":
//       return (
//         <div>
//           <h2 className={fontClass}>View Teacher Result</h2>
//           <ViewTeacherResultTab />
//         </div>
//       );
//     default:
//       return null;
