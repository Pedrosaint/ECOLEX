...
const UpcomingExams = () => {
  return (
    <div>
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-200 py-10 flex flex-col items-center justify-center text-center px-4">
...
//                 <div className="text-sm text-gray-600">{exam.class.customName ?? exam.class.name}</div>
