...
export default function StudentsList() {
  ...
  const handleDisplayStudent = (newFilters: {
    ...
    const hasActiveFilters =
      !!newFilters.campusId || !!newFilters.classId || !!newFilters.name;
              ...
              {!error && data && data.students.length > 0 ? (
                ...
                >
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <button className="bg-[#ED294A] text-white px-5 py-2 rounded-sm flex items-center space-x-2 text-sm font-semibold">
                      <X size={20} />
                      <span>REMOVE</span>
                    </button>
                  </div>
